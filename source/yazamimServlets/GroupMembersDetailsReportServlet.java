 ...
 */
@WebServlet("/pdf/GroupMembersDetailsReportServlet.do")
public class GroupMembersDetailsReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupMembersDetailsReportServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			jasperDesign = JRXmlLoader.load(path+"/groupMembersDetails.jrxml");
			queryText = DBQueries.reportGroupMembersList();
        ...
        String name = "groupMembersDetails.pdf";
